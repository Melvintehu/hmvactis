                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                               @foreach($pageSection->photos as $photo)
                                                <td>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form  enctype="multipart/form-data" action='/cms/pageSection/{{ $pageSection->id }}/photos' method="POST" id="PhotoUpload" class="dropzone" >
                                                            {{ csrf_field() }}
                                                        </form>
